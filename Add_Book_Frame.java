 ...
 * @author Abdullah
 */
public class Add_Book_Frame extends javax.swing.JFrame {

    /**
     * Creates new form Add_Book_Frame
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String bookgenre = jTextField2.getText();
        String bookprice = jTextField3.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Book_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_Book_Frame().setVisible(true);
            }
        });
    }
