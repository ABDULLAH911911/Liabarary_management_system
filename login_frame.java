...
public class login_frame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(username.isEmpty() || password.isEmpty()){
           JOptionPane.showMessageDialog(null, "Username or password can not be empty", "Error", JOptionPane.INFORMATION_MESSAGE);
           return;
        }
        ...
        ResultSet resultset =  userDao.login(user);
        try{
            if(resultset.next()){
                AdminFunctions_frame aff = new AdminFunctions_frame();
                setVisible(false);
                aff.setVisible(true);
