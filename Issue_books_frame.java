...
public class Issue_books_frame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Issue_books_frame
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please Enter the Details of the Book to Issue");

        jLabel2.setText(" Book Id(BID)");

        jLabel3.setText(" User Id(UID)");

        jLabel5.setText("Period(days)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        issuedbook.setPeriod(days);
        boolean status = issuedBookDao.issueABook(issuedbook);
          if(status){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Issue_books_frame().setVisible(true);
            }
        });
    }
